...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    imageStyleRetro: 'Retro',
    imageStyle3d: '3D',
    imageStyleKawaii: 'Cute / Kawaii',
    imageStyleStorybook: 'Storybook illustration',
    imageStylePastel: 'Soft pastel',
  ...
  th: {
    ...
    imageStyleCartoon: 'การ์ตูน',
    imageStyleWatercolor: 'วาดน้ำ',
    imageStyleRetro: 'เรโทร',
    imageStyle3d: 'สามมิติ (3D)',
    imageStyleKawaii: 'น่ารักคาวาอิ',
    imageStyleStorybook: 'ภาพนิทาน',
    imageStylePastel: 'พาสเทลนุ่ม',
