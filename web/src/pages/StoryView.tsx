...
export default function StoryView() {
  ...
  return (
    <div className="min-h-full flex flex-col bg-surface">
      <header className="flex items-center justify-between p-4 border-b border-primary/20 bg-white/60 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="text-secondary font-medium hover:underline focus:outline-none focus:ring-2 focus:ring-secondary rounded cursor-pointer text-sm"
          >
            {t('shareLink')}
          </button>
        </div>
        <h1 className="text-lg font-semibold text-text truncate max-w-[60%]">
          {story.title}
        </h1>
      ...
      <main className="flex-1 flex flex-col sm:flex-row items-stretch overflow-hidden p-4 gap-4">
        ...
        <section className="flex-1 flex flex-col justify-center rounded-2xl bg-white/80 shadow-lg p-6 border border-primary/20">
          ...
          <button
            ...
            className="mt-4 rounded-xl bg-secondary px-4 py-2 text-white font-medium cursor-pointer hover:opacity-90 transition-opacity"
          >
      ...
      <footer className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between p-4 border-t border-primary/20 bg-white/60 gap-4 shrink-0">
        ...
        <button
          ...
          disabled={exporting}
          className="rounded-xl bg-secondary px-4 py-2 text-white font-medium cursor-pointer hover:opacity-90 disabled:opacity-60 transition-opacity"
        >
